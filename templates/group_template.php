...
<style type="text/css">
  ...
  th { width:30px; padding: 6px 3px; border: 1px solid #666; }
  td { width:30px; height: 22px; padding-left: 3px; padding-right: 3px; border: 1px solid #666; }
...
<table>
  ...
  <?php for($i=0;$i<count($players);$i++): ?>
    <tr>
      <td><?php echo ($i+1); ?></td>
      <td class="left"><?php echo htmlspecialchars($players[$i]->name); ?></td>
      <td><?php echo $players[$i]->country_flag_s_tag(); ?></td>
